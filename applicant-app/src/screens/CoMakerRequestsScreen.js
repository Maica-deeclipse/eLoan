...
const s = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 14, fontFamily: 'Poppins_600SemiBold', color: SECONDARY, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 0.5, paddingRight: 0.5 },
...
const modal = StyleSheet.create({
  ...
  sectionLabel:   { fontSize: 11, color: MUTED, fontFamily: 'Poppins_600SemiBold', textTransform: 'uppercase', letterSpacing: 0.5, paddingRight: 0.5, marginBottom: 12 },
