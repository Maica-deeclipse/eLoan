...
const styles = StyleSheet.create({
  ...
  logoText: {fontSize: 32, fontFamily: 'Poppins_700Bold', color: '#1f2937'},
  title: {fontSize: 24, fontFamily: 'Poppins_600SemiBold', color: '#1f2937', marginBottom: 8},
  ...
  label: {fontSize: 14, fontFamily: 'Poppins_500Medium', color: '#374151', marginBottom: 8},
  input: {backgroundColor: '#fff', borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, padding: 12, fontSize: 16, color: '#1f2937'},
  submitButton: {backgroundColor: '#6366f1', borderRadius: 8, padding: 16, alignItems: 'center', marginBottom: 16},
  ...
  backToLoginText: {color: '#6366f1', fontSize: 14, fontFamily: 'Poppins_500Medium'},
  ...
  successTitle: {fontSize: 24, fontFamily: 'Poppins_600SemiBold', color: '#1f2937', marginBottom: 16},
  ...
  backButton: {backgroundColor: '#6366f1', borderRadius: 8, padding: 16, alignItems: 'center', width: '100%'},
  backButtonText: {color: '#fff', fontSize: 16, fontFamily: 'Poppins_600SemiBold'},
});
