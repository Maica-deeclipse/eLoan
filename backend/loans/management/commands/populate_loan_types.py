        ...
        loan_types = [
            {
                ...
                'interest_rate': 12.00,
                'max_term_months': 36,
                'description': 'Loan secured with ATM as collateral. Requires one co-maker, bank statement (3 months), updated balance inquiry, and waiver.',
            },
            {
            ...
            },
            {
                ...
                'interest_rate': 6.00,
                'max_term_months': 12,
                'description': 'Short-term emergency loan for urgent financial needs.',
            },
            {
            ...
            },
            {
                ...
                'interest_rate': 8.00,
                'max_term_months': 12,
                'description': 'Short-term loan with grace period for first payment. Requires two co-makers.',
            },
            {
            ...
            },
            {
                ...
                'interest_rate': 0.00,
                'max_term_months': 3,
                'description': 'Interest-free loan for rice and basic food supplies. Requires one co-maker.',
            },
        ]
