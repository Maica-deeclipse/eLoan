    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['application', 'evaluated_at'], name='treasurer_t_applica_681994_idx'), models.Index(fields=['evaluated_by', 'evaluated_at'], name='treasurer_t_evaluat_36098b_idx')],
            },
        ),
    ]
