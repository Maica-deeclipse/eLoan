          ...
          <div style={{ padding: '1.5rem' }}>
            ...
            <form onSubmit={handleProfileSubmit}>
              <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="bk-firstname" style={labelStyle}>First Name <span style={{ color: '#dc2626' }}>*</span></label>
                <input
                  id="bk-firstname"
                  type="text"
                  name="firstname"
              ...
              <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="bk-lastname" style={labelStyle}>Last Name <span style={{ color: '#dc2626' }}>*</span></label>
                <input
                  id="bk-lastname"
                  type="text"
                  name="lastname"
        ...
        <div style={{
          ...
          <div style={{ padding: '1.5rem' }}>
            <form onSubmit={handlePasswordSubmit}>
              <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="bk-old-password" style={labelStyle}>Current Password <span style={{ color: '#dc2626' }}>*</span></label>
                <PasswordInput
                  id="bk-old-password"
                  name="old_password"
              ...
              <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="bk-new-password" style={labelStyle}>New Password <span style={{ color: '#dc2626' }}>*</span></label>
                <PasswordInput
                  id="bk-new-password"
                  name="new_password"
              ...
              <div style={{ marginBottom: '1rem' }}>
                <label htmlFor="bk-confirm-password" style={labelStyle}>Confirm New Password <span style={{ color: '#dc2626' }}>*</span></label>
                <PasswordInput
